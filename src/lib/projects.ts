...
export const projects: Project[] = [
  {
    ...
    overview:
      "A platform that turns the chaos of college research into one clear, personal flow — fast, clean, and built to scale.",
    purpose:
      "Every year, thousands of students in India face one of the most stressful decisions of their lives — which college, which course, which future? They scroll endlessly, get overwhelmed with information, and often make choices based on incomplete data.",
    need:
    ...
    myRole:
      "As a Web Developer Intern, I built and optimized core features of the platform — from frontend components to backend API connections — ensuring the experience was fast, clean, and intuitive.",
    features: [
  ...
  },
  {
    ...
    live: "https://coral-health-detection.vercel.app",
    github: "https://github.com/Manshi-25/Coral-health-detection",
    overview:
